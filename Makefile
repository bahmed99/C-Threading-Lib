...
BINS= 01-main 02-switch 03-equity 21-create-many 12-join-main 11-join 22-create-many-recursive 23-create-many-once 31-switch-many 32-switch-many-join 33-switch-many-cascade 51-fibonacci 71-preemption 61-mutex 62-mutex 81-deadlock 91-merge-sort 92-quick-sort 
BINS_EXEC= "01-main" "02-switch" "03-equity" "11-join" "12-join-main" "21-create-many 20" "22-create-many-recursive 20" "23-create-many-once 20" "31-switch-many 10 20" "32-switch-many-join 10 20" "33-switch-many-cascade 20 5" "51-fibonacci 16" "61-mutex 20" "62-mutex 20" "71-preemption 3" "81-deadlock" "91-merge-sort 100" "92-quick-sort 100"
