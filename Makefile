...
BINS_EXEC= "01-main" "02-switch" "03-equity" "11-join" "12-join-main" "21-create-many 20" "22-create-many-recursive 20" "23-create-many-once 20" "31-switch-many 10 20" "32-switch-many-join 10 20" "33-switch-many-cascade 20 5" "51-fibonacci 32" "71-preemption 5"
